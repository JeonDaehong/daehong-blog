        ...
        detail: `
          ...
          **💬 꼬리질문 2**
            **Q. MyISAM 과 MEMORY 등 다른 스토리지 엔진에 대해서도 설명해주세요.**
            ...
            ARCHIVE 엔진은 대량의 데이터를 압축하여 저장하는 스토리지 엔진입니다. 데이터가 Insert될 때마다 zlib로 압축되므로 디스크 I/O를 최소화하며, Insert 작업을 빠르게 처리할 수 있습니다. ARCHIVE 엔진은 Insert, Replace, Select 쿼리는 지원하지만 Delete와 Update는 지원하지 않습니다. 잠금 단위는 Row 수준으로 작동합니다. 주로 로그성 데이터나 대량 데이터�� 저장하고 읽는 용도로 사용됩니다. ARCHIVE 엔진은 인덱스를 지원하지 않습니다.
