...
<div className="my-8 space-y-6">
  ...
  <div className="p-4 bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl border-4 border-purple-200 shadow-lg">
    <img src="/apache-iceberg-contributor3.png" alt="Apache Iceberg Contributor 3" style="border: 2px solid skyblue; border-radius: 4px;" width="100%" />
  </div>
</div>
...
이번 기여를 통해 기술적인 역량뿐만 아니라, 오픈소스 프로젝트에서의 커���니케이션의 중요성을 깊이 체감할 수 있었습니다.
