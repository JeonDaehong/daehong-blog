...
1. **일관성 확보**: 하드 코딩된 문자열 대신 상수를 사용함으로써 코드 전체의 일관성을 높였습니다.
...
PR을 올리고 나서 며칠 후, Spring Kafka의 메인테이너 중 한 분이 리뷰를 남겨주셨습니다. 다행히 긍정적인 피드백이었고, 몇 가지 작은 수정 요청이 있었습니다:
...
예를 들어, 웹사이트에서 페이지를 만들거나 이미지를 업로드할 때 그 데이터를 저장하는 데 Oak가 쓰일 수 있습니다. 파일이나 폴더를 디렉토리처럼 관리하고, 누가 언제 바꿨는지 기록도 남길 수 있어서 문서 관리 시스템이나 CMS에 딱 맞는 구조입니다.
