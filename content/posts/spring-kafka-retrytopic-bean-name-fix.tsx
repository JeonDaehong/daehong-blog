...
그러던 중, 오픈소스 기여 방법을 안내해주는 커뮤니티를 알게 되었고, 그곳에서 멘토링 프로그램에 참여하게 되었습니다. 이슈를 찾고, 기여할 부분을 고민하며, 본��적으로 오픈소스의 세계에 발을 들이게 되었습니다.
...
1. **일관성 확보**: 하드���딩된 문자열 대신 상수를 사용함으로써 코드 전체의 일관성을 높였습니다.
